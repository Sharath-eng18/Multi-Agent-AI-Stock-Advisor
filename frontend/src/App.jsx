...
function App() {
  ...
  return (
    <div className="bg-background text-on-background font-body min-h-screen flex flex-col relative selection:bg-primary-container selection:text-on-primary-container">
      ...
      {/* -------------------- TOP APP BAR -------------------- */}
      <header className="bg-background border-b-4 border-outline flex justify-between items-center w-full px-6 md:px-10 py-6 sticky top-0 z-50">
        <div 
          onClick={goToLanding}
        ...
        <div className="flex items-center gap-4">
          {/* Quick Search bar shown in results view */}
          {view === 'result' && (
          ...
          <button className="border-2 border-outline bg-primary text-on-primary font-headline font-black uppercase tracking-tight px-6 py-2 hover:bg-primary-container hover:text-primary transition-colors duration-75 neo-brutalist-shadow neo-brutalist-shadow-hover">
            LOGIN
          </button>
        </div>
      </header>
          ...
          <section className="min-h-[600px] flex flex-col items-center justify-center p-6 bg-background relative">
            ...
            <div className="z-10 w-full max-w-4xl mx-auto flex flex-col items-center space-y-12">
              ...
              <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-6 relative">
                ...
                {/* Step 1: Sentiment */}
                <div className={`border-4 border-outline p-6 shadow-neo transition-all ${
                  analysisStep === 'fetching' 
            ...
            <section className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-16">
              ...
              <div className="lg:col-span-4 border-4 border-outline bg-surface p-6 shadow-neo flex flex-col">
                <div className="flex items-center justify-between border-b-2 border-outline pb-4 mb-6">
                  ...
                  <span className={`px-2.5 py-1 border-2 border-outline font-headline font-black text-xs uppercase ${
                    report.sentiment_score > 0.15 ? 'bg-bauhaus-green text-primary' : 
                  ...
                  {report.news_articles?.map((article, idx) => (
                    ...
                    >
                      ...
                      <div className="flex justify-between items-center text-xs font-bold uppercase text-on-surface-variant">
                        ...
                        <span className={`px-1.5 py-0.5 border border-outline ${
                          article.sentiment_label === 'positive' ? 'bg-green-200 text-green-900' :
